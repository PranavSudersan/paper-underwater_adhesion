...
The seven-spotted adult male adult ladybug beetles (\emph{Coccinella septempuctata})
...
water \emph{ad libitum}. The beetles on average weighed 34 $\pm$ 4 mg and were experimented on within three weeks of being housed under above conditions.
...
with a steel bending beam (spring constant = 68.1 Nm\protect\textsuperscript{-1}) constituted
...
at a speed of 62.5 \textmu ms\protect\textsuperscript{-1}. Ventral view video recordings
...
Five force measurements were subsequently performed on a fresh spot of the substrate and averaged for data analysis. 
Experiments were repeated five times with unique male beetles for each mode of contact (``\emph{in air}'', (``\emph{underwater:
bubble}'' and (``\emph{underwater: no bubble}'') and substrate (hydrophilic, hydrophobic). Thus, in total, 30 beetles were tested.
%CHECK TYPE OF CONTACT CHANGE TO MODE OF CONTACT%
...
negative force during the retraction step (Figure \ref{fig:Setup}).
...
under nitrogen flow. For the hydrophobic substrate, the glass cover slip was coated with
a fluorosilane via chemical vapour deposition (CVD). First, the glass
was cleaned using IPA. The surface was then plasma cleaned in a oxygen
...
for 3 hours. Henceforth, we refer to the hydrophilic normal glass substrate 
...
of 10 \textmu l and with 0.5 \textmu ls\protect\textsuperscript{-1} flow rate (Table \ref{tab:Contact-Angles}).
...
septempuctata}) distal pad on glass (blue) and PFOTS (red) substrates in air and underwater
...
24 mNm\protect\textsuperscript{-1} and 48 mNm\protect\textsuperscript{-1} respectively and water surface tension is 72 mNm\protect\textsuperscript{-1}.}
\end{figure}
...
appear to contact well with either glass or PFOTS substrate, unlike the other
three contact modes (see supplementary info). This ``bad contact'' scenario shows no adhesion %INCLUDE SUPPLEMENTARY%
...
with the substrate (hydrophilic or hydrophobic) in three ways: a) \emph{In air}, where the tarsal adhesive
fluid bridges are surrounded by air; b) \emph{Underwater: no bubble},
where the tarsal adhesive fluid bridges are fully surrounded by water; c)\emph{
Underwater: bubble}, where part of the tarsal adhesive fluid bridges are
...
in water, instead of getting washed away (Table \ref{tab:Molecular-distribution-of}). %CHANGE REFERENCE!%
