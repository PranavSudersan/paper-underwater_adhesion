...
detected (Figure \ref{fig:Effect-of-contact} and Table S.1).
...
tension and Laplace pressure (equation S.1). Force
versus distance for a single capillary bridge was calculated by Surface
Evolver simulations\cite{RN206}  (described in supplementary section S.1),
...
with its Laplace and surface tension components (equation S.1).
