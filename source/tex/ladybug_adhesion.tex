...
Fluid-mediated adhesion seen in animals such as ladybug beetles allow them to attach to surfaces not just in air but also in underwater conditions.
...
Evolver simulations\cite{RN206}  (see supplementary section S1 for details),
...
We are grateful to Prof. Dr. Eduard Arzt and Dr. Ren\textcyr{\`\cyre} Hensel (Leibniz Institute for New Materials, Saarbr\"{u}cken, Germany)  for fruitful discussions. 

\section{Competing interests}
The authors declare no competing or financial interests.

%\section{Data availability}
%Data are available from the Dryad digital repository. %CHECK THIS%

\section{Funding}
This work was supported by the \emph{Deutsche Forschungsgemeinschaft}
