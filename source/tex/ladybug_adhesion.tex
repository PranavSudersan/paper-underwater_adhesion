...
of triglycerides, fatty acids and cholesterol in ladybirds \emph{Hemisphaerota cyanea} and \emph{Epilachna vingtipunctuata}\cite{RN221,RN222}, rendering it immiscible with water. %split references%
...
%mention data points number clearly for each box, what is averaged etc. also%
...
%Include ANOVA as well, include F, t, degrees of freedom%
...
%FDMS keep as unpublished data, remove from supplementary.%
