...
\title{Wetting of the adhesive fluid controls underwater adhesion in insects}
...
\keywords{adhesion; capillary force; underwater;  beetle; gecko}
...
during detachment, tested on smooth glass and
...
consisting of a X-piezo element, used for precise lateral movements, XYZ motors,
for coarse movements and a goniometer, for adjusting substrate alignment
with the optics. Additionally, a separate Z-piezo element, fixed upright,
...
the substrate under reflection mode with the help of epi-illumination.
...
tension effects. This effect needed to be cancelled. So, a ``background''
