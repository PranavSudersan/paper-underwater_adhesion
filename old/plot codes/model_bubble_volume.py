...
color_list = ['r', 'c']#['g', 'b', 'r', 'c'] #corresponding colors
fix_marker = None #set to 'o' if style_param is None else set as None
line_styles = [(1, 0),(1, 1)]#[(1, 0), (1, 1)] #set True if line style needs to be changed by default. or include style as list of tuples {on, off) eg. (1,0): solid, (1,1):dotted

x_param = "a_b"
x_label = r'$\phi_b$'
y_param = "Force"
y_label = r"Adhesion Force, $F_{min}/\gamma s$"
hue_param = "Contact Type" #"Model"
