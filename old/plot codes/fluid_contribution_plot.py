...
#forces scale
modelData['Force Deriv'] *= 2*np.pi
modelData['Total'] *= 2*np.pi
modelData['Laplace'] = (modelData['Pressure'] - modelData['Ambient_Pressure']) * modelData['Bottom_Area']
modelData['Surface Tension'] = -1 * modelData['Bottom_Length'] * np.sin(modelData['Bottom_Angle']*np.pi/180)
...
x_param = "Bottom_Angle"
x_label = "Contact Angle (°)"
y_param = "Force value"
y_label = r"Force, $F_{min}/\gamma s$"
hue_param = "Force" #"Model"
...
ax = sns.relplot(data=data_filtered,
                 x = x_param,
                 y = y_param,
                 hue = hue_param,
